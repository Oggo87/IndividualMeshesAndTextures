...
static const DWORD TweakerHookAddress = 0x0054BB57;

static const DWORD TweakerJumpBackAddress = 0x0054BB5C;
...
public:
    ...
    static void Hook()
    {
        ...
        GP4MemLib::MemUtils::rerouteFunction(TweakerHookAddress, PtrToUlong(LoadTweakerHook), VAR_NAME(LoadTweakerHook));
...
private:
    ...
    void initEnabled()
    {
        ...
        GP4PP::OutputGP4PPDebugString("GP4 Tweaker: " + string(enabled ? "Detected" : "Not Detected"));
        if (enabled)
        {
            ...
            {
				GP4PP::OutputGP4PPDebugString("GP4 Tweaker INI file loaded from: " + iniFilePath);
            }
        }
	}
